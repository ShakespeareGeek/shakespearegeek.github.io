this.bardle = this.bardle || {}, this.bardle.bundle = function(e) {
      ...
      .setting {\n \
           ...
           <section>\n  \
            ...
            <section>\n  \
                <div class="setting">\n   \
                 <div class="text">\n      \
                   <div class="title">Support More Shakespeare Geek Projects</div>\n  \
                 </div>\n   \
                  <div class="control">\n    \
                   <a href="https://ko-fi.com/shakespearegeek" title="Buy me a Red Bull">Buy Me Caffeine!</a>\n   \
                  </div>\n  \
                 </div>\n  \
             </section>\n \
             </div>\n  <div id="footnote">\n    <div>\n          \n    </div>\n    <div>\n          </div>\n  </div>\n';
    ...
    var Answers = ["blunt","naked","thief","doubt","worst","queen","flesh","arden","dream","beard","exits","witch",
    "leeks","pound","blind","gibes","bleed","kills","tiber","twixt","frets","borne","paris","romeo",
    "alack","marry","hovel","robin","curio","gobbo","parts","words","gower","hymen","antic","sooth",
    "nonny","unsex","boyet","jests","mourn","crack","arras","speed","liest","stone","grave","ninus",
    "lucio","aspic","padua","locks","lewis","merry","elbow","aaron","enter","ariel","varro","nurse",
    "mouse","knell","ducat","wound","cliff","brave","plays","smile","petty","havoc","brute","wager",
    "eaten","books","kings","regan","globe","hover","quill","quoth","percy","wench","timon","twain",
    "blank","fools","roses","glove","sound","actor","waste","lafeu","clerk","fiend","madam","dover",
    "sword","lance","ninny","wills","wrote","works","laugh","widow","horse","roman","civil","enemy",
    "biron","night","drama","feast","court","snout","herod","quote","livia","bosom","death","folio",
    "crown","crier","snare","worms","aglet","caius","tiger","canst","prick","loins","doers","heart",
    "grace","agate","twins","cinna","clock","casca","drown","guilt","debts","dance","purse","grief",
    "phebe","pedro","saucy","eater","fifth","rugby","cupid","woods","heath","verse","boult","sixth",
    "glass","trees","mirth","scone","priam","judge","flute","sweet","edgar","groat","greek","thane",
    "angus","shrew","beams","chess","haply","earth","viola","curse","feste","alice","cleon","hoist",
    "seems","fairy","drugs","staff","march","menas","groom","drawn","italy","diana","spite","guard",
    "clown","abbot","hound","noble","drums","bushy","hence","alarm","cheer","swear","devil","green",
    "storm","cheek","helen","essex","atomy","nymph","space","adieu","great","singe","winds","scars",
    "magic","wives","bough","alive","brief","fates","stage","cloak","ceres","osric","idiot","lease",
    "henry","speak","mercy","celia","julia","sleep","knock","peter","coral","stuff","trial","woman",
    "fault","untie","deeds","arise","scene","bawdy","false","skull","friar","fatal","stars","cleft",
    "angel","corin","barge","lover","canon","fenny","aside","stain","spout","thumb","maria","faint",
    "knave","stabs","exile","april","prose","blood","never","tubal","music","uncle","hasty","james",
    "vasty","ghost","knife","cause","charm","peace","third","curan","capon","scout","world","egeus",
    "bride","salad","sting","beast","slain","blade","shone","tears","hands","sport","dower","scorn",
    "drunk","titus","alike"],
          ...
          font-size: 14px;\n
              color: var(--color-tone-1)\n
                ...
                .examples {\n
                    ...
                    <p>Each guess must be a valid 5 letter word. Words come from Shakespeare characters, classic quotes and general 
                    theatre terminology. Hit the enter button to submit.</p>\n      
